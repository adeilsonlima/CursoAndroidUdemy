package br.com.adeilson.preferenciacorusuario;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        botaoSalvar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(idRadioButtonSelecionado>0){
                    radioSelecionado = (RadioButton) findViewById(idRadioButtonSelecionado);

                    SharedPreferences sharedPreferences = getSharedPreferences(ARQUIVO_PREFERENCIA, 0);//modo privado
                    SharedPreferences.Editor editor = sharedPreferences.edit();
                    String corSelecionada = radioSelecionado.getText().toString();
                    editor.putString("corEscolhida", corSelecionada);
                    editor.commit();
        ...
        if (sharedPreferences.contains("corEscolhida")){
            String corEscolhida = sharedPreferences.getString("corEscolhida","Laranja");
